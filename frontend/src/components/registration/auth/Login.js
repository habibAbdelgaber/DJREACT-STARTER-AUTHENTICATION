    ...
    <Row className="justify-content-md-center mt-5">
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '90vh' }}>
        <Col xs={12} md={6}>
          ...
          <p className='fs-5 pt-3'>Forgot you password? <Link to='/accounts/password/reset' className='text-decoration-none'>Reset Password</Link></p>
          <p className='fs-5'>Don't have an account? <Link to='/register' className='text-decoration-none'>Sign up</Link></p>
        </Col>
      </div>
    </Row>
  )
